    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasError) {
          ...
          //                   //       ? const AssetImage("assets/pita.png")
          //                   //       : AssetImage(
          ...
          //                       style: userTextStyle()),
          //                   const SizedBox(height: 10),
          //                   Text("Business Name: ${userData["businessName"]}",
          //                       style: userTextStyle()),
          //                   const SizedBox(height: 10),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 5),
                                    Text(
                                        "Business Address: ${userData["address"]}"),
                                    const SizedBox(height: 5),
                                    JobPosted(userId: userData["id"]),
                                    const SizedBox(height: 10),
                                  ],
                                ),
                              ),
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.data!.size == 0) {
          return const Text("Job Posted: 0");
        }

        final count = snapshot.data!.docs.length;
        return Text("Job Posted: $count");
      },
    );
  }
}
