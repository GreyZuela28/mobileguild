...
class MeetingScreen extends StatefulWidget {
  ...
  @override
  State<MeetingScreen> createState() => _MeetingState();
}
...
class _MeetingState extends State<MeetingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // print(widget.jobName);
      roomText.text = widget.jobId;
      emailText.text = widget.userName;
      subjectText.text = widget.jobName;
      nameText.text = widget.businessName;
